  ...
  return (
    <div className="box box2">
        ...
        <div style={{ display: 'flex', position: 'relative' }}>
          <div className="post" style={{ flex: 1 }}>
            {movieData ? (
              <>
          ...
          <div className="buttonalign" style={{ position: 'absolute', bottom: '20px', right: '-5px' }}>
            <button className="button2" style={{ fontSize: '10px', padding: '10px 20px', marginLeft: '20px' }} onClick={handleAddClick}>
              Add
            </button>
          </div>
        </div>
      ...
      {showPopup && (
        <div className="popup-overlay">
          <div className="popup">
            ...
            {/* Show screen selection if "Now Showing" is selected */}
